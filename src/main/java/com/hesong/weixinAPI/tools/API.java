...
public class API {
    public final static String DES_KEY = "376B4A409E5789CE";
    ...
    public final static String REDIS_NO_CHECKED_STAFF_LIST = "weixin_no_checked_staff_list";
    ...
    // DURATION
    public final static String REDIS_TENANT_WAITING_DURATION = "tenant_waiting_duration";
    public final static String REDIS_TENANT_SESSION_AVAILABLE_DURATION = "tenant_session_avaialbel_duration";
    public final static String REDIS_TENANT_END_SESSION_DURATION_DURATION = "tenant_end_session_duration";
...
//    public static String GET_EXPRESS_MESSAGE_URL = "http://www.clouduc.cn/hsy/rest/n/getquickreply?tenantUn=";
//
//    // CRM urls
//    public static String CLIENT_INFO_URL = "http://www.clouduc.cn/crm/mobile/weixin/prospectsDetail.php?kh_weixin_openid=%s&channel=%s&tenantUn=%s&source=%s";
...
//    public static String GET_LEAVED_MESSAGE_URL = "http://www.clouduc.cn/crm/mobile/replymessage/messagelist.php?openid=";
    ...
    public static String GET_EXPRESS_MESSAGE_URL = "http://www.hesyun.com/hsy/rest/n/getquickreply?tenantUn=";

    // CRM urls
    public static String CLIENT_INFO_URL = "http://www.hesyun.com/crm/mobile/weixin/prospectsDetail.php?kh_weixin_openid=%s&channel=%s&tenantUn=%s&source=%s";
    ...
    public static String GET_LEAVED_MESSAGE_URL = "http://www.hesyun.com/crm/mobile/replymessage/messagelist.php?openid=";
    ...
    public final static String WEIXIN_MEDIA_URL = "http://file.api.weixin.qq.com/cgi-bin/media/get?access_token=ACCESS_TOKEN&media_id=";
    ...
    public final static String QRCODE_URL = "https://mp.weixin.qq.com/cgi-bin/showqrcode?ticket=";
}
